 ...
 */
export type InteractiveElement = ChartElement | CheckboxElement | DropdownElement | ImageElement | MermaidElement | PresetsElement | SliderElement | TabulatorElement | TextboxElement;
